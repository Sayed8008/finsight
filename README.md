...
**Status:** in development (Phase 8 — five working sections: dashboard,
transactions, budgets, subscriptions and analytics, with QtCharts visualisations
and month-on-month comparison)
